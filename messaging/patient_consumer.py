...
class PatientConsumer:
    ...
    def _process_patient_message(self, message: Dict[str, Any]) -> MessageProcessingResult:
        ...
        try:
            ...
            logger.info(
                f"Processing {event_type} for patient {patient_id} (correlation: {correlation_id}, sync: {is_sync_event}, reason: {sync_reason})")
    ...
    def _handle_patient_created(self, db, message_data: Dict[str, Any]) -> MessageProcessingResult:
        ...
        try:
            ...
            try:
                ...
                logger.error(f"[DEBUG] create_ref_patient raised an exception: {e}")
                raise
